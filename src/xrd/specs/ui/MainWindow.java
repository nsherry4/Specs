...
import xrd.specs.SPEcsController;
...
public class MainWindow extends JFrame
{
	...
	private JToolBar createToolbar()
	{
		...
		indexingMI.addActionListener(new ActionListener() {
		...
		peaksMI.addActionListener(new ActionListener() {
			
			@Override
			public void actionPerformed(ActionEvent e)
			{
				actionOpenPeakSearching();
			}
		});
		...
		openindexing.addListener(new EventfulEnumListener<DropdownImageButton.Actions>() {
